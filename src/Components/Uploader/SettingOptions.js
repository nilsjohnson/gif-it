    ...
    return (
      ...
      >
        ...
        <Grid
          ...
          alignItems="center"
        >
          <Button className={classes.btn} onClick={cancel} variant="contained" color="secondary">Cancel</Button>
          <Button className={classes.btn} onClick={convert} variant="contained" color="primary">Convert</Button>
        </Grid>
      </Grid>
    );
  }
